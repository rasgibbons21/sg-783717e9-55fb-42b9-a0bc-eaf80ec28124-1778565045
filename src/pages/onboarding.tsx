                ...
                <div className={`space-y-7 ${animateIn ? "step-animate" : "opacity-0"}`}>
                  <div className="text-center space-y-5">
                    <div className="relative inline-block">
                      <img src="/bloom-logo.png" alt="Radar" className="w-20 h-20 mx-auto rounded-3xl object-cover" style={{ boxShadow: "0 0 50px rgba(73,176,110,0.3)" }} />
              ...
              {step === "auth" && (
                <div className={`space-y-6 ${animateIn ? "step-animate" : "opacity-0"}`}>
                  <div className="text-center space-y-2">
                    <img src="/bloom-logo.png" alt="Radar" className="w-14 h-14 mx-auto rounded-2xl object-cover" style={{ boxShadow: "0 0 30px rgba(39,183,200,0.15)" }} />
