        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {UNIVERSITY_MODULES.map((mod) => {
              const UNLOCKED = new Set(["m1-chart-reading", "m2-chart-patterns", "m3-indicators", "m4-trading-signals", "m5-strategies", "m6-entering", "m7-managing", "m10-candlestick-patterns"]);
