...
const HUSTLES: HustleInfo[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        actions: ["Connect DSers or CJ Dropshipping to your store", "Import your top 3 products", "Rewrite each product description — focus on benefits and emotions", "Add at least 5 quality images per product"],
