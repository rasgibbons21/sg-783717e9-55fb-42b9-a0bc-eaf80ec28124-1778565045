...
const HUSTLES: HustleInfo[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        summary: "Create your online store — Shopify makes it easy, even if you've never done this before.",
        content: "Sign up for Shopify — they offer $1/month for the first 3 months, so there's basically no risk. Pick the Dawn theme (it's free and looks professional). Choose a store name that's short, memorable, and relates to your niche.\n\nSet up your homepage with a clean hero image and a clear value proposition. Add an \"About\" page, a FAQ, and your shipping/return policies. These build trust — people don't buy from sketchy-looking stores.\n\nFor your logo, use Canva (free). Pick 2-3 brand colors that match your niche vibe. A clean, simple logo beats a complicated one every time.",
        actions: ["Sign up for Shopify (link below)", "Pick the Dawn theme and customize colors to match your brand", "Create your logo in Canva and add it to your store"],
        links: [{ label: "Start Shopify Free Trial →", url: AFF.shopify }],
      ...
      },
      {
        ...
        content: "Install the DSers app (free) from the Shopify App Store — it connects directly to AliExpress suppliers. Import your top 3 products with one click. But here's the key: do NOT use the default AliExpress descriptions.\n\nWrite your own product descriptions. Focus on benefits, not features. Instead of \"Made of silicone, 15cm long\" write \"Never burn your fingers again — this heat-resistant grip keeps your hands safe while you cook.\" People buy solutions, not specifications.\n\nUse high-quality images. If the supplier's photos look cheap, order a sample and take your own photos. Good photos = more sales. Period.",
        actions: ["Install DSers from the Shopify App Store", "Import your top 3 products", "Rewrite each product description — focus on benefits and emotions", "Add at least 5 quality images per product"],
      ...
      },
      {
        ...
        content: "Enable Shopify Payments — it's the easiest option and has the lowest fees. Also add PayPal as a backup since some customers prefer it. You want zero friction between \"I want this\" and \"take my money.\"\n\nFor shipping: offer FREE shipping and build the shipping cost into your product price. \"$25 with free shipping\" converts WAY better than \"$18 + $7 shipping\" even though it's the same total. This is psychology, not math.\n\nCreate these required pages: Shipping Policy (be honest about 7-14 day delivery), Return Policy (30-day returns build trust), and Privacy Policy (Shopify has a generator for this).",
        actions: ["Enable Shopify Payments and PayPal", "Set all products to free shipping (adjust prices to cover cost)", "Create Shipping Policy, Return Policy, and Privacy Policy pages"],
      ...
      },
      {
        ...
        content: "When an order comes in, DSers makes fulfillment easy — click \"Place Order\" and it sends the order to your AliExpress supplier automatically. They pack and ship it directly to your customer. You never touch the product.\n\nSend your customer a shipping confirmation with tracking info. Set up an automated email sequence: order confirmation → shipping notification → delivery follow-up → review request. Shopify apps like OrderlyEmails can automate this.\n\nIf a customer messages you, respond FAST. Within 24 hours, ideally within a few hours. Great customer service = good reviews = more sales. It's a beautiful cycle.",
      ...
      },
      {
        ...
        content: "After 2 weeks of running ads, it's time to analyze. Look at your key metrics in Shopify Analytics: total traffic, conversion rate (should be 1-3%), average order value, and profit margin after ad spend.\n\nKill any ads with CTR below 0.8% or cost per purchase above your profit margin. Duplicate winning ads with slight variations (different thumbnail, different opening line, different audience). This is called \"scaling\" and it's how you grow.\n\nTest new products! Add 2-3 new products to your store each week. Some will flop, some will fly. The more you test, the faster you find winners.",
        actions: ["Review your Shopify Analytics — write down conversion rate and top-performing products", "Kill underperforming ads, duplicate winning ones with variations", "Add 2-3 new products to test this week"],
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        actions: ["Find suppliers on AliExpress or CJ Dropshipping for your niche", "Order samples of your top 5 product picks", "Test each sample — would YOU be happy receiving this?"],
