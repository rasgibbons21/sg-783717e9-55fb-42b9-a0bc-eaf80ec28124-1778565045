...
const HUSTLES: HustleInfo[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        actions: ["Sign up for Shopify (shopify.com)", "Pick the Dawn theme and customize colors to match your brand", "Create your logo in Canva and add it to your store"],
