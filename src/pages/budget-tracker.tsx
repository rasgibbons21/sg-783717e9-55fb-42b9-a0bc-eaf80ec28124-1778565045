...
export default function BudgetTracker() {
  ...
  return (
    <Layout>
      <SEO title="Free Budget Tracker for Women — Track Spending | Radar" description="Track your income and expenses by category with Pansy's smart insights. See monthly spending breakdowns, set budget goals, and find hidden savings. Free budgeting tool designed for women." />
