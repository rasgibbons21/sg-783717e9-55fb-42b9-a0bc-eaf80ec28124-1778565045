      ...
      <div style={{ fontFamily:"'DM Sans', sans-serif", background:C.deep, color:C.ivory, minHeight:"100vh", display:"flex", flexDirection:"column" }}>
        ...
        <main style={{ flex:1, maxWidth:720, margin:"0 auto", padding:"6rem 1.5rem 4rem", textAlign:"center" }}>
          ...
          <p style={{ fontSize:"1.1rem", lineHeight:1.7, color:"rgba(244,247,250,0.65)", marginBottom:"1rem" }}>
            Your daily investing ritual — a market briefing, a lesson, a wealth habit, and Pansy&apos;s take, all in five minutes.
          </p>
          <p style={{ fontSize:"0.9rem", color:"rgba(244,247,250,0.38)", marginBottom:"3rem" }}>
            We&apos;re putting the finishing touches on this experience. Sign up now and you&apos;ll get it the day it launches.
          </p>

          <div style={{ display:"flex", flexWrap:"wrap", justifyContent:"center", gap:16, marginBottom:"4rem" }}>
            {[
              { icon:"☀️", title:"Market Briefing",  body:"Plain-English recap of the last session." },
              { icon:"📚", title:"Today's Lesson",    body:"One concept, explained clearly, at your pace." },
              { icon:"🌱", title:"Wealth Habit",      body:"One small action that compounds over time." },
              { icon:"💬", title:"Pansy's Take",      body:"Her read on what's moving markets today." },
            ].map(({ icon, title, body }) => (
