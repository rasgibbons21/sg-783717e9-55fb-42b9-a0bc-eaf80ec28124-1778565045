...
export default function Contact() {
  return (
    <Layout>
      <SEO
        title="Contact Us - Radar"
        description="Contact Cinder Vault Enterprises LLC for Radar support and inquiries"
      />
          ...
          <Card className="border-accent bg-gradient-to-br from-accent/20 to-background p-8 flex flex-col justify-center">
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <p className="text-foreground leading-relaxed">
                Have questions about Radar, your account, or need technical help? Our team is ready to assist you. 
