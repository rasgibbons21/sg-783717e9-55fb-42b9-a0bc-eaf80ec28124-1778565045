      ...
      >
        ...
        <div className="px-6 py-5 space-y-5">
          ...
          <p className="text-[10px] text-muted-foreground/50 leading-relaxed">
            Affiliate Disclosure: This link is an affiliate or referral link. Radar may receive compensation if you open an account or purchase a service, at no additional cost to you.
          </p>
