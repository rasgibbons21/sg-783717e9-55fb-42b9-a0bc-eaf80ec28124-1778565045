...
## Notes
Add a Market News section to the Home page that displays recent news articles for stocks in the user's watchlist. Fetch from Finnhub API and display in a clean card layout with Dahlia's girlfriend-tone commentary.
...
- [x] Add Dahlia's intro text with flower emoji
