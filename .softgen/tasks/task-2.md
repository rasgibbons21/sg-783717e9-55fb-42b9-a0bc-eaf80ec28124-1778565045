...
## Notes
Main dashboard with personalized greeting, live market data, Pansy's picks, market movers. Bottom nav with 5 tabs.
...
- [x] Pansy's Picks Today: horizontal scroll of stock cards with ticker, name, price, change badge, insight quote box, CTA button
- [x] Disclaimer strip at bottom
- [x] Integrate Pansy returning user popup on first load
